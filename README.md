...
On average, domestic beer is 86% of the price of imported beer. For the chart, 'Restaurant vs Home Beer, Domestic vs Import, Beer vs Food' we are focused on cities where customers are willing to pay a premium for domestic beer, so the selected cities demonstrate this.
